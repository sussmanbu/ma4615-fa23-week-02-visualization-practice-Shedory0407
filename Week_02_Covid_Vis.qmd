...
I observed an increased trend in cases.

2. Are there any conclusions you can draw?

That the number of COVID-19 cases is rising over the time period depicted in the plot.

3. What were you not able to do due to not having the R knowledge?

I won't be able to visualize, transform, and model the data efficiently.

4. What other data would be useful to better understand this data?

Other data such as information on hospitalizations and deaths might help understanding the severity of Covid among different races better.